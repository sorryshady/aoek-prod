...
import {
  AdminComments,
  adminCommentsSchema,
} from "@/schemas/admin-comments-schema";
...
const UserRequests = () => {
  ...
  const form = useForm<AdminComments>({
  ...
  const handleRequestAction = async (data: AdminComments) => {
            ...
            <form onSubmit={form.handleSubmit(handleRequestAction)}>
              ...
              <DialogFooter className="mt-4">
                <SubmitButton
                  type="submit"
                  variant={
                    requestAction === "VERIFIED" ? "default" : "destructive"
                  }
                  title={requestAction === "VERIFIED" ? "Approve" : "Reject"}
